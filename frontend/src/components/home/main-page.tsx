...
export const MainPage = () => {
    ...
    return (
        <div
            className={[
                "w-full h-full flex flex-col gap-4 min-w-0",
                "xl:grid xl:grid-cols-[2fr_1fr] xl:grid-rows-[auto_1fr_1fr]",
            ].join(" ")}
        >
            <div className="order-first min-w-0 xl:order-0 xl:col-start-2 xl:row-start-1">
                <LiveStreams />
            </div>

            <div className="min-w-0 bg-background-transparent bg-opacity-10 backdrop-blur-sm rounded-lg flex xl:col-start-1 xl:row-span-3">
                <CurrentRecords />
            </div>
            ...
            <div className="min-w-0 bg-background-transparent bg-opacity-10 backdrop-blur-sm rounded-lg flex xl:col-start-2 xl:row-start-3">
