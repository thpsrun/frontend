...
export function RegisterPage() {
    ...
    // This is mostly to help put the registeration into multiple phases (one for SRC API Key, one for username/password).
    // You will need an SRC API Key in order to create an account.
    ...
    const handleRegister = async (e: React.SubmitEvent) => {
        ...
        // Django has a lot of checks for this, but this is to be doubly-sure.
